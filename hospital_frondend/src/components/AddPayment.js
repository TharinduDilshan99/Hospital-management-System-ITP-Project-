       ...
       <div className="add_pay">
           ...
           <center><h1>ADD PAYMENT</h1></center>
              ...
              <div className="kl-0">
                  ...
                  <input type="text" className="form-control" id="patient_id" placeholder="Enter Bill ID" 
                  onChange={(e)=>{
              ...
              <div className="kl-3">
                  ...
                  <input type="text" className="form-control" id="p_num" oninvalid="this.setCustomValidity('Please Enter Your Number')" placeholder="Enter Phone Number" maxLength="9" pattern="[0-9]{2}[0-9]{7}"
                  onChange={(e)=>{
              ...
              <div className="kl-4">
                  ...
                  <input type="text" className="form-control"  oninvalid="this.setCustomValidity('Please Enter Amount')"id="amount" placeholder="Enter Amount" 
                  onChange={(e)=>{
              ...
              <div className="kl-5">
                  ...
                  <input type="text" className="form-control" id="pay_method"  oninvalid="this.setCustomValidity('Please Enter Method')" placeholder="Enter Payment Method" 
                  onChange={(e)=>{
