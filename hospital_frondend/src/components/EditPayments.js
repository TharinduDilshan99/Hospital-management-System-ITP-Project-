    ...
    <form onSubmit={e => onSubmit(e)}>
      ...
      {/*  <div className="kl-0">
        ...
        <div className="kl-2">
          ...
          <input type="text" className="form-control" id="patient_nic" placeholder="Enter Patient NIC" name="patient_nic" value={patient_nic}  onChange={(e)=>onInputChange(e)} required  />
        </div>
